...
# Mouth
# Dot 1
rtx.scene.append( Sphere(V3(-0.35, 1.5, -7.7), 0.08, button))

# Dot 2
rtx.scene.append( Sphere(V3(-0.35+0.2, 1.5-0.2, -7.7), 0.08, button))

# Dot 3
rtx.scene.append( Sphere(V3(0.35-0.2, 1.5-0.25, -7.4), 0.08, button2))

#Dot 4
rtx.scene.append( Sphere(V3(0.35, 1.44, -7.4), 0.08, button2))
